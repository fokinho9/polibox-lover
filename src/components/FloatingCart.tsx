    ...
    <>
      ...
      {totalItems > 0 && !isCartOpen && (
        <button
          ...
          className="fixed bottom-24 right-6 z-50 w-16 h-16 bg-gradient-to-br from-primary to-cyan-glow text-primary-foreground rounded-2xl shadow-lg flex items-center justify-center transition-all hover:scale-110 group"
        >
      ...
      {/* Cart Panel */}
      <div 
        className={`fixed top-0 right-0 h-full w-full max-w-md border-l border-primary/20 z-50 transform transition-transform duration-300 shadow-2xl ${
      ...
      >
        <div className="flex flex-col h-full relative">
          ...
          {/* ✅ CONTINUAR COMPRANDO FIXADO */}
          <div className="sticky top-[72px] z-50 bg-[hsl(220,18%,10%)]">
            <button
              onClick={() => setIsCartOpen(false)}
