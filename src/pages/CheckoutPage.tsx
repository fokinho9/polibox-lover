            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-4">
                    ...
                    <div className="border-t border-border pt-3 mt-3">
                      <div className="flex justify-between font-bold text-xl">
                        ...
                        <span className="text-primary">
                          {formatPrice(paymentMethod === 'pix' ? pixTotal : totalPrice)}
                        </span>
                      </div>
                      {paymentMethod !== 'pix' && (
                        <p className="text-xs text-muted-foreground mt-1">
                          ou <span className="text-primary font-bold">{formatPrice(pixTotal)}</span> no PIX
                        </p>
                      )}
                    </div>
                  </div>
                ...
                <div className="bg-card rounded-2xl border border-border p-4 space-y-4">
                  <h3 className="font-bold text-center text-sm text-muted-foreground uppercase tracking-wide">
                    Compra 100% Segura
                  </h3>
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  <div className="flex items-center gap-1.5 px-3 py-1.5 bg-card border border-border rounded-full text-xs">
